---
name: create-command
description: Create a new Trellis command for this project by generating the command content and adding the required files.
---

This is the Codex entry for the Trellis `create-command` workflow in this repository.
