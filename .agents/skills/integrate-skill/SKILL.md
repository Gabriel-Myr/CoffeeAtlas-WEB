...
description: Integrate an external skill into this project's Trellis guidelines by adapting it into repo-specific development documentation.
---

This is the Codex entry for the Trellis `integrate-skill` workflow in this repository.
