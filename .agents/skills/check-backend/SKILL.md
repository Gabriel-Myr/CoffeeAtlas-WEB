---
name: check-backend
description: Review changed backend code against this project's Trellis backend guidelines and fix any violations.
---

This is the Codex entry for the Trellis `check-backend` workflow in this repository.
