---
name: parallel
description: Run the Trellis multi-agent parallel workflow for complex tasks, including planning, task setup, and execution guidance.
---

This is the Codex entry for the Trellis `parallel` workflow in this repository.
