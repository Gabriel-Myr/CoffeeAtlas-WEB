---
name: break-loop
description: Perform Trellis deep bug analysis after fixing an issue, identify root causes, and capture prevention knowledge in specs.
---

This is the Codex entry for the Trellis `break-loop` workflow in this repository.
...
- [ ] Update the relevant `.trellis/spec/<package>/<layer>/` docs
