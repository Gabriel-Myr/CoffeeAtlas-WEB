---
name: record-session
description: Record completed work into Trellis workspace journals and task metadata after the human has tested and committed the code.
---

This is the Codex entry for the Trellis `record-session` workflow in this repository.
