---
name: update-spec
description: Update this project's Trellis code-spec documents with concrete contracts, conventions, gotchas, and lessons learned.
---

This is the Codex entry for the Trellis `update-spec` workflow in this repository.
