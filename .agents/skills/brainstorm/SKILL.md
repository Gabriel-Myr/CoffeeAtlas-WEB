---
name: brainstorm
description: Use the Trellis brainstorming workflow to clarify a complex task, iteratively refine requirements, and shape the PRD before implementation.
---

This is the Codex entry for the Trellis `brainstorm` workflow in this repository.
