...
description: Read the Trellis backend guidelines for this project before making backend changes so work follows local conventions.
---

This is the Codex entry for the Trellis `before-backend-dev` workflow in this repository.
