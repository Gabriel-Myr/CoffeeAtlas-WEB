...
**Goal:** 把 `/Users/gabi/CoffeeAtlas-Web/apps/api/lib/catalog.ts` 拆成 focused module，并保留 `catalog.ts` 作为兼容入口，降低 God file 维护成本。
...
**Files:**
- Create: `apps/api/tests/catalog-core.test.ts`
- Create: `apps/api/tests/catalog-exports.test.ts`
- Create: `apps/api/tests/catalog-contract.typecheck.ts`
- Read: `apps/api/lib/catalog.ts`
...
**Files:**
- Create: `apps/api/lib/catalog-types.ts`
- Modify: `apps/api/lib/catalog.ts`
- Test: `apps/api/tests/catalog-contract.typecheck.ts`
...
**Files:**
- Create: `apps/api/lib/catalog-core.ts`
- Modify: `apps/api/lib/catalog.ts`
- Test: `apps/api/tests/catalog-core.test.ts`
...
**Files:**
- Create: `apps/api/lib/catalog-beans.ts`
- Modify: `apps/api/lib/catalog.ts`
- Test: `apps/api/tests/catalog-exports.test.ts`
...
**Files:**
- Create: `apps/api/lib/catalog-roasters.ts`
- Modify: `apps/api/lib/catalog.ts`
- Test: `apps/api/tests/catalog-exports.test.ts`
...
重点关注：
- `apps/api/lib/server/public-api.ts`
- `apps/api/lib/server/public-beans.ts`
- `apps/api/lib/server/public-bean-discover.ts`
- `apps/api/lib/server/favorites-api.ts`
- `apps/api/lib/server/new-arrival-filters-service.ts`
- `apps/api/app/HomePageClient.tsx`
- `apps/api/app/all-beans/AllBeansClient.tsx`
- `apps/api/components/atlas/OriginAtlasExplorer.tsx`
...
**Files:**
- Review: `apps/api/lib/catalog.ts`
- Review: `apps/api/lib/catalog-core.ts`
- Review: `apps/api/lib/catalog-beans.ts`
- Review: `apps/api/lib/catalog-roasters.ts`
- Review: `apps/api/tests/catalog-core.test.ts`
- Review: `apps/api/tests/catalog-exports.test.ts`
