...
// ../../node_modules/.pnpm/@tarojs+plugin-platform-weapp@3.6.30_@swc+helpers@0.5.15_@tarojs+components@3.6.30_@tarojs+he_ylqvpfizk55ntz3dpgxvqjkpiy/node_modules/@tarojs/plugin-platform-weapp/dist/runtime.js
...
function initNativeApi(taro) {
    (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_0__.processApis)(taro, wx, {
        needPromiseApis,
        modifyApis (apis) {
...
var hostConfig = {
    ...
    transferHydrateData (data, element, componentsAlias) {
        ...
        if (element.isTransferElement) {
            ...
            page.setData({
                [(0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_0__.toCamelCase)(data.nn)]: data
            });
            return {
                sid: element.sid,
                ["v"]: "",
...
(0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_0__.mergeReconciler)(hostConfig);
(0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_0__.mergeInternalComponents)(components);
