...
/* harmony import */ var _chunk_3JYJNJZ2_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-3JYJNJZ2.js */ "./node_modules/.taro/weapp/prebundle/chunk-3JYJNJZ2.js");
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-ZKSGX42O.js */ "./node_modules/.taro/weapp/prebundle/chunk-ZKSGX42O.js")["nav"];
...
var require_react_reconciler_production_min = (0,_chunk_3RWA6CQF_js__WEBPACK_IMPORTED_MODULE_3__.__commonJS)({
    "../../node_modules/.pnpm/react-reconciler@0.27.0_react@18.2.0/node_modules/react-reconciler/cjs/react-reconciler.production.min.js" (exports, module) {
        module.exports = function $$$reconciler($$$hostConfig) {
            var exports2 = {};
            "use strict";
            var aa = (0,_chunk_3JYJNJZ2_js__WEBPACK_IMPORTED_MODULE_2__.require_react_production_min)(), ba = require_scheduler(), ca = Object.assign;
            function n(a) {
...
// ../../node_modules/.pnpm/@tarojs+react@3.6.30_@tarojs+runtime@3.6.30_@tarojs+shared@3.6.30__@tarojs+shared@3.6.30_react@18.2.0/node_modules/@tarojs/react/dist/react.esm.js
...
function getUpdatePayload(dom, oldProps, newProps) {
    ...
    const isFormElement = dom instanceof _chunk_ZKSGX42O_js__WEBPACK_IMPORTED_MODULE_0__.FormElement;
    for(i in newProps){
...
function setEvent(dom, name, value, oldValue) {
    ...
    const compName = (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.capitalize)((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.toCamelCase)(dom.tagName.toLowerCase()));
    if (eventName === "click" && compName in _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.internalComponents) {
        eventName = "tap";
    }
    if ((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (oldValue) {
...
function setStyle(style, key, value) {
    ...
    style[key] = (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isNumber)(value) && IS_NON_DIMENSIONAL.test(key) === false ? value + "px" : value == null ? "" : value;
}
function setProperty(dom, name, value, oldValue) {
    ...
    if (name === "key" || name === "children" || name === "ref") ;
        ...
        if ((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isString)(value)) {
            style.cssText = value;
        } else {
            if ((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isString)(oldValue)) {
                style.cssText = "";
                oldValue = null;
            }
            if ((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(oldValue)) {
            ...
            if ((0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(value)) {
    ...
    } else if (!(0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(value)) {
        if (value == null) {
...
var hostConfig = {
    ...
    resetAfterCommit: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    createInstance (type, props, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const element = _chunk_ZKSGX42O_js__WEBPACK_IMPORTED_MODULE_0__.document$1.createElement(type);
    ...
    finalizeInitialChildren (dom, type, props) {
        let newProps = props;
        if (dom instanceof _chunk_ZKSGX42O_js__WEBPACK_IMPORTED_MODULE_0__.FormElement) {
    ...
    createTextInstance (text, _rootContainerInstance, _hostContext, internalInstanceHandle) {
        const textNode = _chunk_ZKSGX42O_js__WEBPACK_IMPORTED_MODULE_0__.document$1.createTextNode(text);
    ...
    beforeActiveInstanceBlur: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    afterActiveInstanceBlur: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    preparePortalMount: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    prepareScopeUpdate: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    getInstanceFromScope: ()=>null,
    getCurrentEventPriority () {
        return import_constants.DefaultEventPriority;
    },
    detachDeletedInstance: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    // -------------------
    //      Microtasks
    //     (optional)
    // -------------------
    supportsMicrotasks: true,
    scheduleMicrotask: (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isUndefined)(Promise) ? setTimeout : (callback)=>Promise.resolve(null).then(callback).catch(function(error) {
            setTimeout(()=>{
                throw error;
            });
        }),
    ...
    commitMount: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    resetTextContent: _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.noop,
    ...
    unhideInstance (instance, props) {
        ...
        display = display == null || (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isBoolean)(display) || display === "" ? "" : ("" + display).trim();
...
function createRoot(domContainer, options = {}) {
    ...
    _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("dispatchTaroEvent", (e, node)=>{
        const eventPriority = getEventPriority(e.type);
        TaroReconciler.runWithPriority(eventPriority, ()=>{
            node.dispatchEvent(e);
        });
    });
    _chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.hooks.tap("modifyTaroEvent", (e, node)=>{
        var _a2, _b;
...
function unmountComponentAtNode(dom) {
    (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.ensure)(dom && [
        1,
        8,
        9,
        11
...
var portalType = (0,_chunk_ZSBEHKUT_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(Symbol) && Symbol.for ? Symbol.for("react.portal") : 60106;
