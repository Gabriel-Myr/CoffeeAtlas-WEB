...
const COUNTRY_META: Array<Omit<OriginAtlasCountry, 'color' | 'path'>> = [
  { id: 'yunnan', name: '云南', continentId: 'asia', aliases: ['中国云南', 'yunnan'], flavorLabel: '茶感·甘蔗甜·木质香', editorialLabel: '横断山脉的云雾高地，让甜感与干净度一起抬升。', accent: '#C2573C', notableRegions: ['保山', '普洱', '临沧'] },
  { id: 'indonesia', name: '印尼', continentId: 'asia', aliases: ['印度尼西亚', 'indonesia', 'sumatra', 'java'], flavorLabel: '草本·黑糖·厚实口感', editorialLabel: '群岛地形让风味更宽广，常带有热带雨林般的深度与厚度。', accent: '#B65F47', notableRegions: ['苏门答腊', '爪哇', '苏拉威西'] },
  { id: 'vietnam', name: '越南', continentId: 'asia', aliases: ['vietnam', 'da lat'], flavorLabel: '可可·果甜·饱满质地', editorialLabel: '从达拉特高地到中南半岛腹地，风味线条更直给也更浓缩。', accent: '#DA7E5E', notableRegions: ['大叻', '林同', '山罗'] },
  { id: 'thailand', name: '泰国', continentId: 'asia', aliases: ['thailand', 'chiang mai', 'chiang rai'], flavorLabel: '熟果·焦糖·明亮甜酸', editorialLabel: '北部山地与热带气候交叠，常呈现圆润甜感和柔和花果香。', accent: '#D98B6A', notableRegions: ['清迈', '清莱', 'Doi Chang'] },
  { id: 'india', name: '印度', continentId: 'asia', aliases: ['india', 'karnataka'], flavorLabel: '香料·巧克力·低调果调', editorialLabel: '季风与阴影种植带来更圆润的体感，香料调是它的独特记忆点。', accent: '#C96D52', notableRegions: ['卡纳塔克', '巴巴布丹吉里', 'Kerala'] },
  { id: 'yemen', name: '也门', continentId: 'asia', aliases: ['yemen', 'mocha', 'haraz'], flavorLabel: '红酒果香·香料·干果甜', editorialLabel: '古老梯田与干旱高地共同塑造了浓缩而神秘的层次。', accent: '#A44B39', notableRegions: ['哈拉兹', '摩卡', '巴尼马塔尔'] },
  { id: 'ethiopia', name: '埃塞俄比亚', continentId: 'africa', aliases: ['ethiopia', 'yirgacheffe', 'sidama', 'guji'], flavorLabel: '茉莉·柑橘·莓果', editorialLabel: '它像一张风味坐标原点，高海拔与原生种带来极高辨识度。', accent: '#B78C40', notableRegions: ['耶加雪菲', '西达摩', '古吉'] },
  { id: 'kenya', name: '肯尼亚', continentId: 'africa', aliases: ['kenya', 'nyeri', 'kirinyaga'], flavorLabel: '黑醋栗·番茄·闪亮酸质', editorialLabel: '肯尼亚常把酸质推到前景，结构锋利却仍保持甜感支撑。', accent: '#C69A4D', notableRegions: ['涅里', '基里尼亚加', '穆兰加'] },
  { id: 'rwanda', name: '卢旺达', continentId: 'africa', aliases: ['rwanda', 'huye'], flavorLabel: '蜂蜜·花香·柠檬皮', editorialLabel: '小而紧凑的高地国家，杯中常能看到清晰花香与柔亮酸值。', accent: '#D1A65D', notableRegions: ['胡耶', '尼亚马谢凯', 'Gakenke'] },
  { id: 'tanzania', name: '坦桑尼亚', continentId: 'africa', aliases: ['tanzania', 'mbeya', 'kilimanjaro'], flavorLabel: '黑莓·可可·干净尾韵', editorialLabel: '火山山体与湖区气候并存，让风味在果感和可可调之间摇摆。', accent: '#C69B57', notableRegions: ['姆贝亚', '乞力马扎罗', '阿鲁沙'] },
  { id: 'uganda', name: '乌干达', continentId: 'africa', aliases: ['uganda', 'bugisu', 'rwenzori'], flavorLabel: '黑糖·果干·厚实口感', editorialLabel: '被湖泊和高地包围的地貌，让乌干达既有醇厚感也能出现明亮果调。', accent: '#AF8848', notableRegions: ['布吉苏', '鲁文佐里', '西尼罗'] },
  { id: 'colombia', name: '哥伦比亚', continentId: 'americas', aliases: ['colombia', 'huila', 'narino', 'tolima'], flavorLabel: '焦糖·坚果·橙感酸质', editorialLabel: '安第斯山系把哥伦比亚切成多个风味走廊，平衡是它最稳定的特征。', accent: '#5D917A', notableRegions: ['慧兰', '纳里尼奥', '托利马'] },
  { id: 'brazil', name: '巴西', continentId: 'americas', aliases: ['brazil', 'cerrado', 'mogiana', 'sul de minas'], flavorLabel: '巧克力·榛果·圆润甜感', editorialLabel: '巴西不是单一风味，而是一整块大地形下的稳定甜感和坚果基底。', accent: '#4E826B', notableRegions: ['塞拉多', '莫吉亚纳', '南米纳斯'] },
  { id: 'guatemala', name: '危地马拉', continentId: 'americas', aliases: ['guatemala', 'antigua', 'huehuetenango'], flavorLabel: '可可·红糖·细致酸感', editorialLabel: '火山土与高海拔让危地马拉的风味拥有很强的骨架感。', accent: '#7AA08B', notableRegions: ['安提瓜', '薇薇特南果', '科班'] },
  { id: 'costa-rica', name: '哥斯达黎加', continentId: 'americas', aliases: ['costa rica', 'tarrazu', 'west valley'], flavorLabel: '柑橘·蜂蜜·清晰甜感', editorialLabel: '处理法创新与高海拔小农体系，让它常带有明亮且精致的轮廓。', accent: '#7FA48E', notableRegions: ['塔拉珠', '西谷', '中央谷地'] },
  { id: 'panama', name: '巴拿马', continentId: 'americas', aliases: ['panama', 'boquete', 'volcan'], flavorLabel: '花香·佛手柑·茶感尾韵', editorialLabel: '细长的地峡连接两洋，也连接了极端精致与极高辨识度。', accent: '#89B19B', notableRegions: ['波奎特', '沃肯', 'Renacimiento'] },
  { id: 'peru', name: '秘鲁', continentId: 'americas', aliases: ['peru', 'cajamarca', 'cusco'], flavorLabel: '可可·柑橘·柔和甜感', editorialLabel: '安第斯西侧山脉让秘鲁呈现柔和结构和更温润的果酸。', accent: '#6A977E', notableRegions: ['卡哈马卡', '库斯科', '亚马逊纳斯'] },
  { id: 'honduras', name: '洪都拉斯', continentId: 'americas', aliases: ['honduras', 'copan', 'comayagua'], flavorLabel: '焦糖·坚果·可可甜', editorialLabel: '高地与微气候丰富，使它经常成为兼顾甜感与性价比的产地。', accent: '#88AD97', notableRegions: ['科潘', '科马亚瓜', '圣巴巴拉'] },
  { id: 'nicaragua', name: '尼加拉瓜', continentId: 'americas', aliases: ['nicaragua', 'jinotega', 'matagalpa'], flavorLabel: '黑糖·香料·顺滑质地', editorialLabel: '大湖区与火山带共同拉出更厚实、更香料化的尾韵。', accent: '#6F977F', notableRegions: ['希诺特加', '马塔加尔帕', 'Nueva Segovia'] },
  { id: 'el-salvador', name: '萨尔瓦多', continentId: 'americas', aliases: ['el salvador', 'apaleca', 'santa ana'], flavorLabel: '花香·焦糖·温柔酸质', editorialLabel: '体量虽小，却常凭波旁系品种展现出优雅而安静的层次。', accent: '#89AE98', notableRegions: ['阿帕内卡', '圣安娜', 'Chalatenango'] },
  { id: 'mexico', name: '墨西哥', continentId: 'americas', aliases: ['mexico', 'chiapas', 'oaxaca', 'veracruz'], flavorLabel: '坚果·可可·温和柑橘', editorialLabel: '南部高地和原住民小农体系，让墨西哥更像一张温和而稳定的底图。', accent: '#5E8A74', notableRegions: ['恰帕斯', '瓦哈卡', '韦拉克鲁斯'] },
  { id: 'ecuador', name: '厄瓜多尔', continentId: 'americas', aliases: ['ecuador', 'loja', 'pichincha'], flavorLabel: '柑橘·红糖·轻盈花香', editorialLabel: '安第斯与赤道交叠，风味常显得轻快而有空气感。', accent: '#79A08A', notableRegions: ['洛哈', '皮钦查', '萨莫拉'] },
  { id: 'bolivia', name: '玻利维亚', continentId: 'americas', aliases: ['bolivia', 'caranavi', 'la paz'], flavorLabel: '花香·核果·稀有甜感', editorialLabel: '高原边缘与亚马逊坡地让它经常出现细密又稀有的花果层次。', accent: '#6A8D77', notableRegions: ['卡拉纳维', '拉巴斯', 'Yungas'] },
];
...
export function getCountriesByContinent(continentId: OriginAtlasContinent['id']): OriginAtlasCountry[] {
  return ORIGIN_ATLAS_COUNTRIES.filter((country) => country.continentId === continentId);
}
...
export function buildCountryAtlasStats(beans: CoffeeBean[]): Map<string, CountryAtlasStats> {
  ...
  for (const [, stats] of statsMap) {
    ...
    const priced = stats.beans.filter((bean) => bean.price > 0);
    stats.averagePrice = priced.length > 0 ? Math.round(priced.reduce((sum, bean) => sum + bean.price, 0) / priced.length) : null;
...
export function getContinentSummary(continentId: OriginAtlasContinent['id'], statsMap: Map<string, CountryAtlasStats>) {
