...
const { data, error } = await db
  .from('roaster_beans')
  .select('id, roaster_id, source_id, bean_id, display_name, status, is_in_stock, price_amount, image_url, product_url, source_item_id, source_sku_id, created_at, updated_at, retire_at')
