...
test('parseBeansQueryParams normalizes shared bean list filters', () => {
  const result = parseBeansQueryParams(
    new URLSearchParams(
      'page=2&pageSize=120&q=%E8%8A%B1%E9%A6%99&roasterId=roaster-1&origin=%E5%9F%83%E5%A1%9E%E4%BF%84%E6%AF%94%E4%BA%9A&process=%E6%B0%B4%E6%B4%97&roastLevel=%E6%B5%85%E7%83%98&sort=updated_desc&isNewArrival=true&continent=africa&country=ET'
    ),
    {
      defaultPageSize: 50,
      maxPageSize: 100,
